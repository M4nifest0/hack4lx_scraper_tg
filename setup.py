...
def requirements():
	def csv_lib():
		banner()
		print(gr+'['+cy+'+'+gr+']'+cy+' Lotfan Kamai Tahamol Namaeid Dar Hale Nasb Mibashad ...')
		os.system("""
	...
	banner()
	print(gr+'['+cy+'+'+gr+']'+cy+' Lotfan Kamai Tahamol Namaeid Dar Hale Nasb Mibashad ...')
	input_csv = input(gr+'['+cy+'+'+gr+']'+cy+' Aya Emkan Faal Sazi CSV Anjam shavad (y/n): ').lower()
	if input_csv == "y":
		csv_lib()
	else:
		pass
...
def merge_csv():
	...
	print(gr+'['+cy+'+'+gr+']'+cy+' Shayad Zaman Bar Bashad ... ')
...
def update_tool():
	...
	banner()
	source = r.get("ttps://raw.githubusercontent.com/attakercyebr/hack4lx_scraper_tg/master/.image/.version")
	if source.text == '3':
...
try:
	...
	print(gr+'['+re+'!'+gr+']'+cy+' for help use : ')
	print(gr+'['+re+'!'+gr+']'+cy+' https://github.com/attakercyebr/hack4lx_scraper_tg/blob/master/README.md')
	print(gr+'$ python3 setup.py -h'+'\n')
